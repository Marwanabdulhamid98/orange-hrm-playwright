...
class AddEmployeePage:
    ...
    def fill_inputs_create_employee(self,firstname: str, midllename: str, lastname: str):
    ...
    def create_employee(self,firstname: str, midllename: str, lastname: str):
        self.fill_inputs_create_employee(firstname=firstname,midllename=midllename,lastname=lastname)
        self.save_details()
    ...
    def create_employee_with_login_details(self,firstname: str, midllename: str, lastname: str,username: str, password: str):
        ...
        self.password_confirmation_login.fill(password)
